...
void __init setup_IO_APIC(void)
{
    ...
    printk("XEN-BLANKET: enabling hyper-v IRQ vector\n");
    clear_irq_vector(7);
    cpumask_setall(&mask_all);
	if ((ret = bind_irq_vector(7, 0x37, &mask_all)))
		printk(KERN_ERR"..XEN-BLANKET: CAN NOT enabling hyper-v IRQ vector!!!, err:%d\n", ret);
}
